...
Public Class Form1
    ...
    Private Sub Flash_image_to_ESP(ByVal filename As String)
        ...
        Try
            ...
            MsgBox("Pokud má deska tlačítko BOOT, nyní je pořeba ho stisknout a držet, dokud se flashování nedokončí.", MsgBoxStyle.Information)
            ...
            While Not erase_process.StandardOutput.EndOfStream
                TextBox1.Text = TextBox1.Text & erase_process.StandardOutput.ReadLine & vbNewLine
                TextBox1.Refresh()
